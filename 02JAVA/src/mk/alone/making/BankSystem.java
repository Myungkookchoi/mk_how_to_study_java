...
public class BankSystem {
	...
	public static int loginState = BankSystem.LOGIN_LOG_OFF;
	...
	public static void login() {
		login: while (loginState == BankSystem.LOGIN_LOG_OFF) {
			...
			if (inputId.equals(adminId)) {
				if (inputPw.equals(adminPw)) {
					loginState = BankSystem.LOGIN_ADMIN_USER;
				...
				for (int i = 0; i < totalUserCount; i++) {
					if (id[i].equals(inputId)) {
						if (pw[i].equals(inputPw)) {
							...
							loginState = BankSystem.LOGIN_NORMAL_USER;
							loginIndex = i;
							userMenu();
							continue login;
						} else {
	...
	public static void userMenu() {
		...
		while (isUserMenu) {
			...
			if (input1.equals("1")) {
				...
				loginState = BankSystem.LOGIN_LOG_OFF;
				isUserMenu = false;
			}
		}
	}
