...
class User1 {// 이미등록된 사용자 정보를 담는 객체
	...
	public User1(int loginState, String id, String pw, int account) {
...
public class TEST31_6 {
	...
	public static User1[] userArray = new User1[10];
	public static String inputId = ""; // 입력받을 로그인 아이디
	public static String inputPw = ""; // 입력받을 패스워드
	public static double inputAccount = 0;
	public static int userCount = 0;
	public static int loginIndex = 0;
	public boolean isFlag = true;

	public static User1 nowUser = null;

	public static void init() {
		userArray[userCount++] = new User1(User.LOGIN_NORMAL_USER, "user1", "user1", 0);
		userArray[userCount++] = new User1(User.LOGIN_NORMAL_USER, "user2", "user2", 0);
		userArray[userCount++] = new User1(User.LOGIN_NORMAL_USER, "user3", "user3", 0);
		userArray[userCount++] = new User1(User.LOGIN_ADMIN_USER, "admin1", "admin1", 0);
		userArray[userCount++] = new User1(User.LOGIN_ADMIN_USER, "admin2", "admin2", 0);
	...
	public static void adminMenu() {
		...
		while (isAdminLogin) {
			...
			case "1":
				...
				str = sc.nextLine();
				if (str.equals("1")) {
					u.loginState = User1.LOGIN_NORMAL_USER;
				} else {
					u.loginState = User1.LOGIN_ADMIN_USER;
				}
	...
	public static void playBank() {
		...
		while (isMainMenu) {
			...
			if (nowUser != null) {// 로그인 성공
				...
				case User1.LOGIN_LOG_OFF: // 로그아웃 상태
					System.out.println("사용할 수 없는 ID입니다. - 로그아웃 상태");
					break;
				case User1.LOGIN_NORMAL_USER: // 일반 사용자로 로그인한 상태
					userMenu();
					break;
				case User1.LOGIN_ADMIN_USER: // 관리자 상태로 로그인한 상태
					adminMenu();
					break;
				}
